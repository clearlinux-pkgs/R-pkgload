...
Version  : 1.4.0
Release  : 54
URL      : https://cran.r-project.org/src/contrib/pkgload_1.4.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/pkgload_1.4.0.tar.gz
...
%setup -q -n pkgload
pushd ..
cp -a pkgload buildavx2
popd
pushd ..
cp -a pkgload buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719595263
...
/usr/lib64/R/library/pkgload/print-var.mk
