...
Version  : 1.2.3
Release  : 32
URL      : https://cran.r-project.org/src/contrib/pkgload_1.2.3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/pkgload_1.2.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634271974
